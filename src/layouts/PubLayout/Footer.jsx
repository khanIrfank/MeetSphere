...
export default function Footer() {
  return (
    <footer className="border-t border-soft mt-24 select-none bg-surface">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 py-14 grid grid-cols-2 md:grid-cols-5 gap-10">
        <div className="col-span-2">
          <div className="flex items-center gap-2.5 font-display font-bold text-lg text-theme-heading mb-3">
          ...
          <p className="text-sm text-theme-sub max-w-xs font-medium leading-relaxed">
        ...
        {[
          ...
          <div key={col.title}>
            <h4 className="text-sm font-extrabold text-theme-heading mb-3">{col.title}</h4>
            <ul className="space-y-2 text-sm text-theme-sub font-semibold">
              {col.items.map((i) => (
      ...
      <div className="border-t border-soft py-6 text-center text-xs text-theme-sub font-semibold">
